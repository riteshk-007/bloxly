export const editorTheme = {
  ...
  rtl: "text-right",
  heading: {
    h1: "text-3xl font-bold text-yellow-500 mb-4 mt-6",
    h2: "text-2xl font-bold text-yellow-500 mb-3 mt-5",
    h3: "text-xl font-bold text-yellow-500 mb-2 mt-4",
    h4: "text-lg font-bold text-yellow-500 mb-2 mt-3",
    h5: "text-base font-bold text-yellow-500 mb-1 mt-2",
    h6: "text-sm font-bold text-yellow-500 mb-1 mt-2",
  },
  paragraph: "text-base text-white leading-relaxed mb-2",
  quote: "border-l-4 border-yellow-500 pl-4 italic text-gray-300 my-4",
